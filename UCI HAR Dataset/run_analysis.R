...
download.file('https://d396qusza40orc.cloudfront.net/getdata%2Fprojectfiles%2FUCI%20HAR%20Dataset.zip'
              , 'Samsung_Galaxy_S_smartphone.zip'
              , mode='wb' )

unzip("Samsung_Galaxy_S_smartphone.zip")

wd <- "E:/data.sci/Getting and Cleaning Data/Getting-and-Cleaning-Data-Course-Project-Final/UCI HAR Dataset"
...
###Create New datasets by extracting only the measurements on the mean and 
